...
// Admin reader for the lead-magnet store. Same auth + date-filter contract as
// get-waitlist.ts. Reached at /api/admin/lead-magnet.
...
export default async (req: Request, _context: Context): Promise<Response> => {
  ...
  try {
    ...
    console.error("get-lead-magnet error:", err);
