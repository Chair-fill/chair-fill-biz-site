...
// Admin reader for the durable founding-member store. Same auth + date-filter
// contract as get-waitlist.ts. Reached at /api/admin/founding-members.
...
export default async (req: Request, _context: Context): Promise<Response> => {
  ...
  try {
    ...
    console.error("get-founding-members error:", err);
